...
public class AlterarSenhaTest {
    ...
    @Test
    public void RealizarOPreenchimentoDoCampoNovaSenhaComUmaSenhaForaDoPadraoEVerificarOCampoNovaSenhaInformandoAObrigatoriedadePadraoDasSenha(){
        test = extent.createTest("Realizar o preenchimento do campo Nova senha com uma senha fora do padrão e verificar o campo nova senha informando a obrigatoriedade padrão das senhas.");
        PerfilTela perfilTela = new BemVindoTela(app)
                .botaoAvancar()
                .botaoAvancar()
                .botaoAvancar()
        ...
        if(perfilTela.mensagemAtencaoPadraoSenha().equals(perfilTela.mensagemAtencaoAOPadraoSenha())){
            test.pass("Teste Aprovado");
        }else{
            test.fail("Teste Reprovado");
        }

        Assertions.assertEquals(perfilTela.mensagemAtencaoPadraoSenha(), perfilTela.mensagemAtencaoAOPadraoSenha());
    }

    @Test
    public void RealizarOPreenchimentoDosDoisCamposComSenhasDirefentesEVerificarMensagemDeSenhasNaoCorrespondem(){
        test = extent.createTest("Realizar o preenchimento dos campos com senhas diferentes e verificar mensagem de senha não correspondem.");
        PerfilTela perfilTela = new BemVindoTela(app)
                .botaoAvancar()
                .botaoAvancar()
                .botaoAvancar()
        ...
        if(perfilTela.mensagemCamposNaoCorrespondem().equals(perfilTela.mensagemSenhaNaoCorrespondem())){
            test.pass("Teste Aprovado");
        }else{
            test.fail("Teste Reprovado");
        }

        Assertions.assertEquals(perfilTela.mensagemCamposNaoCorrespondem(), perfilTela.mensagemSenhaNaoCorrespondem());
    }
}
